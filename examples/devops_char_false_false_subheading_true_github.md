...
*a:* add changelog generator ([description](#c17b8bba-3))

*a:* add warning for using arguments

*a:* add readme ([description](#f64c16e3-3))
...
*c:* change inline description to use blockquote ([description](#bf070051-3))
