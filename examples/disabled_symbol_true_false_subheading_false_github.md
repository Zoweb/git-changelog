...
*+* `c17b8bba`: add changelog generator ([description](#add-changelog-generator-25))

*+* `463bb7ba`: add warning for using arguments

*+* `f64c16e3`: add readme ([description](#add-readme-25))
...
*&ast;* `bf070051`: change inline description to use blockquote ([description](#change-inline-description-to-use-blockquote-25))
