...
*+* add changelog generator ([description](#add-changelog-generator-11))

*+* add warning for using arguments

*+* add readme ([description](#add-readme-11))
...
*&ast;* change inline description to use blockquote ([description](#change-inline-description-to-use-blockquote-11))

*&ast;* change text newline to be before each commit ([description](#change-text-newline-to-be-before-each-commit-11))
